...
# load data
 # load(file = 'dataAirbnb.Rda'); load(file = 'dataTest.Rda'); load(file = 'data.s.Rda')
load(file = 'training.Rda')
load(file = 'dataTest.Rda')
load(file = 'testing.Rda')
load(file = 'testing.residual.Rda')
...
load(file = 'submission.part1.Rda')
